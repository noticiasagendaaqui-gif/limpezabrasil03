...
INSERT INTO `agendamentos` (`cliente_id`, `tipo_servico`, `frequencia`, `data_preferida`, `horario_preferido`, `status`) VALUES
(1, 'residencial', 'mensal', '2025-09-15', 'manha', 'confirmado'),
(2, 'comercial', 'semanal', '2025-09-16', 'tarde', 'pendente'),
(3, 'carpetes', 'unica', '2025-09-17', 'manha', 'concluido');
*/
